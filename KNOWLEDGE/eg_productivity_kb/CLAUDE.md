...
A personal knowledge base focused on productivity — how to get meaningful work done, manage attention, design systems, and operate at a high level without burning out. The goal is to compound everything I learn about productivity into a single, well-organised body of knowledge that gets smarter over time.

This is the worked example shipped with CoWork OS. Customise the focus areas below to match your own thinking, or delete this KB and create your own from scratch using the librarian.

## Focus Areas

This knowledge base pays attention to:
- Attention and energy management
- Systems design and personal workflows
- Deep work and essentialism
- The trade-off between effort and effortlessness

Edit these to match what you actually want to compound knowledge on. Three to five themes is the sweet spot — enough to steer compile passes, narrow enough to keep the KB on-topic.
